<template>
 <div class="overview">
   <div class="mobileWelcome" v-if="this.mobile">
      <h1 style="float: left">Hello Dave!</h1>
      <p style="color: black;">Here you can find your projects.</p>
      </div>
    <div>
      ...
      >
        ...
        <template slot="categoryoperation" slot-scope="text, record">
          <img
            v-if="record.category=='A'"
            alt="A"
            src="../assets/images/categoryicon/A.svg"
            height="60px"
          />
          <img
            v-else-if="record.category=='B'"
            alt="B"
            src="../assets/images/categoryicon/B.svg"
            height="60px"
          />
          <img
            v-else-if="record.category=='C'"
            alt="C"
            src="../assets/images/categoryicon/C.svg"
            height="60px"
          />
          <img
            v-else-if="record.category=='D'"
            alt="D"
            src="../assets/images/categoryicon/D.svg"
            height="60px"
          />
          <img
            v-else-if="record.category=='E'"
            alt="E"
            src="../assets/images/categoryicon/E.svg"
            height="60px"
          />
          <img
            v-else-if="record.category=='F'"
            alt="F"
            src="../assets/images/categoryicon/F.svg"
            height="60px"
          />
        </template>
